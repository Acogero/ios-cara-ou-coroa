...
/// Classe AppDelegate -
SWIFT_CLASS("_TtC13Cara_ou_Coroa11AppDelegate")
...
SWIFT_CLASS("_TtC13Cara_ou_Coroa22DetalhesViewController")
@interface DetalhesViewController : UIViewController
/// Outlet que irá receber a imagem
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imgMoedas;
...
///
/// \endcodeClasse View Controller
SWIFT_CLASS("_TtC13Cara_ou_Coroa14ViewController")
@interface ViewController : UIViewController
/// Botão de ação
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified btnJogar;
/// Função de carregamento
- (void)viewDidLoad;
/// Função de memoria
- (void)didReceiveMemoryWarning;
